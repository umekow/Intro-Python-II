...
print(
    "This a game where you can move to different rooms. Press 'n' to move north. Press 's' to move south. Press 'e' to move east. Press 'w' to move west. Press 'q' to quit."
)
while user_input != "q":
